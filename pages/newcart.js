    ...
    sendEmail() {
        ...
        .then(data =>
            ...
            fetch('/api/updateorderbook', {
                ...
                const emailinfo = {template_params: template_params, service: process.env.NEXT_PUBLIC_EMAIL_SERVICE, template: process.env.NEXT_PUBLIC_EMAIL_TEMPLATE, user: process.env.NEXT_PUBLIC_EMAIL_USER};
                fetch('/api/sendemail', {
                    method: 'POST',
